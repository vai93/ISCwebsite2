...
(function () {
  ...
  imgs.forEach((img) => {
    ...
    img.addEventListener("load", () => {
      loaded++;
      if (loaded >= imgs.length) setPaused(false);
    });
...
(function () {
  const CONTENT = {
    vision: {
      ...
      body: "To be the most trusted and innovative partner in electrical control panels and automation solutions, delivering industry-leading quality and building long-term relationships through reliability, advanced technology, and customer-focused excellence.",
    },
    mission: {
      title: "Mission",
      sub: "Every step, planned and executed with care.",
      body: "At Indian Switchgears and Consultants, our mission is to design, manufacture, and deliver high-quality electrical control panels and automation solutions that empower industries with safety, efficiency, and innovation. With over 45+ years of expertise, we are committed to providing value through precision engineering, timely execution, and customer-centric service.",
    },
    values: {
      title: "Core Values",
